...
var COMMIT = "COMMIT";
var ON_ACTION_BUTTON_CLICKED = "ON_ACTION_BUTTON_CLICKED";
...
function reducer(state, action) {
    ...
    switch (action.type) {
        ...
        case ON_ACTION_BUTTON_CLICKED: {
            var data = action.payload.data;
            return __assign(__assign({}, state), { actionData: data });
        }
        case SET_CELL_DATA: {
...
var Cell = function (_a) {
    ...
    return (React.createElement("td", { ref: rootRef, className: classNames("Spreadsheet__cell", data === null || data === void 0 ? void 0 : data.className, {
        ...
        }), onMouseOver: handleMouseOver, onMouseDown: handleMouseDown, tabIndex: 0, style: { maxWidth: "200px", wordWrap: "break-word", whiteSpace: "normal" } },
...
var Spreadsheet = function (props) {
    var className = props.className, darkMode = props.darkMode, columnLabels = props.columnLabels, rowLabels = props.rowLabels, hideColumnIndicators = props.hideColumnIndicators, hideRowIndicators = props.hideRowIndicators, isActionButtonEnable = props.isActionButtonEnable; props.allowExtraRow; var columnStructure = props.columnStructure, onKeyDown = props.onKeyDown, _a = props.Table, Table$1 = _a === void 0 ? Table : _a, _b = props.Row, Row$1 = _b === void 0 ? Row : _b, _c = props.HeaderRow, HeaderRow$1 = _c === void 0 ? HeaderRow : _c, _d = props.DataEditor, DataEditor$1 = _d === void 0 ? DataEditor : _d, _e = props.DataViewer, DataViewer$1 = _e === void 0 ? DataViewer : _e, _f = props.onChange, onChange = _f === void 0 ? function () { } : _f, _g = props.onModeChange, onModeChange = _g === void 0 ? function () { } : _g, _h = props.onSelect, onSelect = _h === void 0 ? function () { } : _h, _j = props.onActivate, onActivate = _j === void 0 ? function () { } : _j, _k = props.onBlur, onBlur = _k === void 0 ? function () { } : _k, _l = props.onCellCommit, onCellCommit = _l === void 0 ? function () { } : _l, _m = props.onActionButtonClicked, onActionButtonClicked = _m === void 0 ? function () { } : _m;
    ...
    var actionButtonClicked = React.useCallback(function (rowNumber, actionPressed) {
        var data = { rowNumber: rowNumber, actionPressed: actionPressed };
    ...
    var columnSum = React.useMemo(function () {
        var sumColumns;
        if (columnStructure) {
            sumColumns = columnStructure.some(function (item) { return item.allowSum || item.allowAverage; });
        }
        return sumColumns;
    }, [columnStructure]);
    React.useEffect(function () {
    ...
    var tableNode = React.useMemo(function () { return (React.createElement(Table$1, { columns: size.columns, hideColumnIndicators: hideColumnIndicators },
        React.createElement(HeaderRow$1, null,
            ...
            isActionButtonEnable && !hideColumnIndicators && (React.createElement("th", { className: "Spreadsheet__header" }))),
        range(size.rows).map(function (rowNumber) { return (React.createElement(Row$1, { key: rowNumber, row: rowNumber },
            ...
            isActionButtonEnable && (React.createElement(React.Fragment, null,
                React.createElement("td", { className: "Spreadsheet__header" }, columnSum && rowNumber === size.rows - 1 ? (React.createElement(React.Fragment, null)) : React.createElement(React.Fragment, null,
                    React.createElement("div", { className: "svgImage" },
                        React.createElement("a", { title: "Insert row above", onClick: function () { return actionButtonClicked(rowNumber, "addAbove"); } },
                            React.createElement("span", { className: "Spreadsheet__cell__icon icon-table-add-row-above-svgrepo-com" })),
                        React.createElement("a", { title: "Insert row below", onClick: function () { return actionButtonClicked(rowNumber, "addBelow"); } },
                            React.createElement("span", { className: "Spreadsheet__cell__icon icon-table-add-row-below-svgrepo-com" })),
                        React.createElement("a", { title: "Delete row", className: "delete", onClick: function () { return actionButtonClicked(rowNumber, "delete"); } },
                            React.createElement("span", { className: "Spreadsheet__cell__icon icon-trash-o" }))))))))); }))); }, [
        Table$1,
        size.rows,
        size.columns,
        hideColumnIndicators,
...
export { DataEditor, DataViewer, EmptySelection, EntireAxisSelection, EntireColumnsSelection, EntireRowsSelection, EntireSelection, EntireWorksheetSelection, InvalidIndexError, PointRange, RangeSelection, Selection, Spreadsheet, createEmpty as createEmptyMatrix, createFormulaParser, Spreadsheet as default };
