...
var DataEditor = function (_a) {
    ...
    return (React__namespace.createElement("div", { className: "Spreadsheet__data-editor" },
        React__namespace.createElement("textarea", { ref: inputRef, onChange: handleChange, value: value, autoFocus: true })));
};
...
var Spreadsheet = function (props) {
    ...
    var actionButtonClicked = React__namespace.useCallback(function (rowNumber, actionPressed) {
    ...
    var columnSum = React__namespace.useMemo(function () {
        var sumColumns;
        if (columnStructure) {
    ...
    var tableNode = React__namespace.useMemo(function () { return (React__namespace.createElement(Table$1, { columns: size.columns, hideColumnIndicators: hideColumnIndicators },
        React__namespace.createElement(HeaderRow$1, null,
            ...
            isActionButtonEnable && !hideColumnIndicators && (React__namespace.createElement("th", { className: "Spreadsheet__header" }))),
        range(size.rows).map(function (rowNumber) { return (React__namespace.createElement(Row$1, { key: rowNumber, row: rowNumber },
            ...
            isActionButtonEnable && (React__namespace.createElement(React__namespace.Fragment, null,
                React__namespace.createElement("td", { className: "Spreadsheet__header" }, columnSum && rowNumber === size.rows - 1 ? (React__namespace.createElement(React__namespace.Fragment, null)) : React__namespace.createElement(React__namespace.Fragment, null,
                    React__namespace.createElement("div", { className: "svgImage" },
                        React__namespace.createElement("a", { title: "Insert row above", onClick: function () { return actionButtonClicked(rowNumber, "addAbove"); } },
                            React__namespace.createElement("span", { className: "Spreadsheet__cell__icon icon-table-add-row-above-svgrepo-com" })),
                        React__namespace.createElement("a", { title: "Insert row below", onClick: function () { return actionButtonClicked(rowNumber, "addBelow"); } },
                            React__namespace.createElement("span", { className: "Spreadsheet__cell__icon icon-table-add-row-below-svgrepo-com" })),
                        React__namespace.createElement("a", { title: "Delete row", className: "delete", onClick: function () { return actionButtonClicked(rowNumber, "delete"); } },
                            React__namespace.createElement("span", { className: "Spreadsheet__cell__icon icon-trash-o" }))))))))); }))); }, [
        Table$1,
        size.rows,
        size.columns,
        hideColumnIndicators,
